...
# Escribe un programa en python que lea el fichero *movies.json con datos de películas. A continuación deberá crear un fichero primerapellido_peliculasaventuras.json 
# con los títulos de las películas cuyo género incluya aventura.
